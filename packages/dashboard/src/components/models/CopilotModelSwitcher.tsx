...
export function CopilotModelSwitcher() {
  ...
  return (
    <div
      className="fixed right-4 top-3 z-50 flex items-center gap-2 rounded-xl border border-blue-400/20 bg-surface/95 px-3 py-2 shadow-xl backdrop-blur"
    ...
    >
      ...
      <select
        ...
        className="max-w-[240px] rounded-lg border border-border bg-background px-2 py-1.5 text-xs outline-none focus:border-blue-400 disabled:opacity-50"
