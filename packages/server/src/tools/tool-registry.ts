...
export const BUILTIN_TOOLS: BuiltinToolDefinition[] = [
  ...
  {
    id: 'content.compliance_check',
    name: 'Social Compliance Check',
    description: 'Apply the configured deterministic social compliance rulebook to platform drafts.',
    category: 'content',
    riskLevel: 'low',
    version: '1.0.0',
    implementationRef: 'packages/server/src/skills/tool-sandbox.ts:executeTool',
    inputSchema: {
      ...
      properties: {
        ...
        documents: { type: 'array', minItems: 1, items: { type: 'object' } },
      },
    },
    outputSchema: { type: 'object' },
    metadata: { readOnly: true, network: false, destructive: false, writesWorkspace: false, writesOutsideWorkspace: false },
  },
  {
    ...
    description: 'Inspect local image/video files for dimensions, format, codec, duration and metadata risk.',
    category: 'asset',
    riskLevel: 'low',
    version: '1.0.0',
    implementationRef: 'packages/server/src/skills/tool-sandbox.ts:executeTool',
  ...
  {
    id: 'social.schedule_check',
    name: 'Social Schedule Conflict Check',
    description: 'Check durable social publishing schedules for account and time-window conflicts.',
    category: 'content',
    riskLevel: 'low',
    version: '1.0.0',
    implementationRef: 'packages/server/src/skills/tool-sandbox.ts:executeTool',
  ...
  {
    id: 'social.monitor_plan',
    name: 'Social Monitor Plan',
    description: 'Persist 48/72/168-hour post-publication monitoring jobs for a published item.',
    category: 'content',
    riskLevel: 'medium',
    version: '1.0.0',
    implementationRef: 'packages/server/src/skills/tool-sandbox.ts:executeTool',
    ...
    outputSchema: { type: 'object' },
    metadata: { readOnly: false, network: false, destructive: false, writesWorkspace: false, writesOutsideWorkspace: false },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        theme: { type: 'string', enum: ['warm', 'clean', 'dark', 'tech', 'editorial', 'notebook'] },
      },
    },
    outputSchema: { type: 'object' },
